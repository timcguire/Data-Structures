...
Due Date: February 19, 2021  Due Time: 11:59 PM
Total Points: 25 Assignment 6: sentence program
Description: manage a singly linked list with pointers to the front and back of the
singly-linked list. Allocate memory dynamically. implement a default, explicit-value and copy constructors.
A destructor. add a node to a singly-linked list. delete a node anywhere in a singly-linked list
